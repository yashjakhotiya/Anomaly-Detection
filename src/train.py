...
print(precision_score(train_labels, train_preds, average="macro"))
print(recall_score(train_labels, train_preds, average="macro"))  
...
print(precision_score(test_labels, test_preds, average="macro"))
print(recall_score(test_labels, test_preds, average="macro"))    